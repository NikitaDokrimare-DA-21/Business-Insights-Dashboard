...
📖 Usage
Launch the app and upload a business CSV dataset (must include columns like Sales, Profit, Order ID, Customer ID, Discount, Category, Region, Segment — a sample Superstoredata.csv is included).
Review the auto-generated KPI cards and charts.
Type a business question in the "Ask Your Business Question" box (e.g. "What can we do to improve profit in the worst-performing region?").
Click 🚀 Generate AI Insights to get a full AI-generated report with an executive summary, key insights, risks, opportunities, recommendations, and a business health score.
...
👤 Author
Nikita Dokrimare GitHub Profile
